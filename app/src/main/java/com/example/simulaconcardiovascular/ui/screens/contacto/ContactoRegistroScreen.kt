...
import com.example.simulaconcardiovascular.validarPhone

@Composable
fun ContactoRegistroScreen(
    ...
    val listaContactos = viewModel.buscar(id).collectAsState(initial = emptyList())

    listaContactos.value.forEach {
        viewModel.nombre = it.nombreContacto
        viewModel.telefono = it.telefonoContacto
    }
